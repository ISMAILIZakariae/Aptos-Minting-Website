    ...
    <div  className="mx-auto px-auto " >
      <div className={styles.container}>
        ...
        <main className={styles.main}>
          ...
          <img src={collectionCoverUrl} style={{ width: "480px", height:"480px", borderRadius:'15px' }} />
          <div id="collection-info" className="d-flex flex-column align-items-center text-white" style={{width: "80%"}}>
            ...
            <>
            <div className="p-3 mt-3 bg-dark border border-success rounded-5">
              <div className="d-flex align-items-center my-3">
                ...
                <button className={styles.button} onClick={mint} disabled={wallet.account?.address?.toString() === undefined}>{mintInfo.minting ? <Spinner animation="border" role="status"><span className="visually-hidden">Loading...</span></Spinner> : "Mint"}</button>
                <h4 className="mx-3 mb-0">{(candyMachineData.data.mintFee * mintInfo.numToMint).toFixed(2)}<span style={{color:'#01d293'}}> $APT</span></h4>
                <span style={{width: "15px", height: "15px", borderRadius: "50%", background: candyMachineData.data.isPublic ? "#01d293" : "red"}}></span>
              </div>
              <h5 style={{marginLeft: '100px'}}>{candyMachineData.data.numMintedTokens}/ {COLLECTION_SIZE} <span style={{fontFamily:"'Montserrat', sans-serif"}}>minted</span> </h5>
              <div className="d-flex flex-column align-items-center my-3">
                <h3 style={{fontFamily:"'Montserrat', sans-serif"}}>Presale In:</h3>
              ...
              <div className="d-flex flex-column align-items-center my-3">
                <h3 style={{fontFamily:"'Montserrat', sans-serif"}}>Public In:</h3>
